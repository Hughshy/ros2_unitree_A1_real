...
UNITREE_LEGGED_SDK::LowCmd rosMsg2Cmd(const ros2_unitree_legged_msgs::msg::LowCmd::SharedPtr &msg, UNITREE_LEGGED_SDK::LowCmd cmd_)
{
    ...
    for (int i(0); i < 20; i++)
    {
        cmd_.motorCmd[i] = rosMsg2Cmd(msg->motor_cmd[i]);
